  ...
  return (
    <div className="w-full flex-row justify-center items-center py-25 bg-[#1c2b4f]">
      <Container>
        ...
        {/* Poin agen perubahan */}
        <div className="grid grid-cols-2 lg:grid-cols-4 w-full justify-center items-center bg-white rounded-xl text-black text-center py-10 px-6 gap-4">
          ...
          <div>
            <div className="w-full grid grid-cols-2 gap-4">
              ...
              <div className="w-full flex flex-col justify-center items-center space-y-4">
                ...
                <div>
                  <p className="w-70 lg:w-full font-semibold text-lg">
