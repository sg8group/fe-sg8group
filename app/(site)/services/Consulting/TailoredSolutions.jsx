          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <h2 className="text-3xl font-bold leading-tight">
                We provide tailored solutions to ensure your business thrives in
                a competitive environment.
              </h2>
              <p className="text-gray-300 text-lg">
                Our Goal is Helping businesses achieve sustainable growth,
                operational efficiency, and long-term profitability with
