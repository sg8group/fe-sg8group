...
const headhuntingFeatures = [
  "Executive Search", "Professional & Specialist Search",
  "Mass Hiring & Volume Recruitment", "Project-Based Recruitment", "Confidential Search",
];
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
          ...
          >
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              With a strategic approach and deep industry insights, we go beyond conventional hiring...
            </p>
