        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {[1, 2, 3, 4, 5, 6].map((item) => (
            <div key={item} className="flex flex-col items-center group">
              ...
              <div className="relative w-full aspect-square max-w-70 bg-gray-200 rounded-lg overflow-hidden border border-gray-300">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-[150%] h-px bg-gray-400 rotate-45 transform origin-center"></div>
                </div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-[150%] h-px bg-gray-400 -rotate-45 transform origin-center"></div>
                </div>
              ...
              <div className="mt-6 w-full max-w-50 space-y-3">
